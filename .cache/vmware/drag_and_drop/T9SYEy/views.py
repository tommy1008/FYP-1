...
from .models import MyUser, Feedback, Exchange, FAQ, Place, Country, Activities, Review, Rating, Contact, Hotel, Flight, \
    ...
    New, ShopHistory, LoginHistory, Themes, Blog, BlogCategory, Continent, Plan, Employee, Department, Function, EmployeeHistory, Benefit
...
appbuilder.add_view(ExchangeView, "Exchange", icon="fa-folder-open-o", category='Manage', )
...
appbuilder.add_view(ActivitiesView, "Activities", icon="fa-folder-open-o", category='Manage', )
...
appbuilder.add_view(HotelView, "Hotel", icon="fa-folder-open-o", category='Manage', )
...
appbuilder.add_view(InvoiceView, "Invoice", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(TicketView, "Ticket", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(DiscountView, "Discount", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(WeatherView, "Weather", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(CultureView, "Culture", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(BookingView, "Booking", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(FlightTicketView, "FlightTicket", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(CateGoryView, "CateGory", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(ForumPlaceView, "ForumPlace", icon="fa-folder-open-o", category='Manage', )
...
appbuilder.add_view(NewView, "New", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(ShopHistoryView, "ShopHistory", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(LoginHistoryView, "LoginHistory", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(ThemesView, "Themes", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(BlogView, "Blog", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(BlogCategoryView, "BlogCategory", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(ContinentVaiew, "Continent", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view(PlanView, "Plan", icon="fa-folder-open-o", category='Manage', )
appbuilder.add_view_no_menu(EmployeeHistoryView, "EmployeeHistoryView")
appbuilder.add_view(EmployeeView, "Employees", icon="fa-folder-open-o", category="Manage")
appbuilder.add_separator("Manage")
appbuilder.add_view(DepartmentView, "Departments", icon="fa-folder-open-o", category="Manage")
appbuilder.add_view(FunctionView, "Functions", icon="fa-folder-open-o", category="Manage")
appbuilder.add_view(BenefitView, "Benefits", icon="fa-folder-open-o", category="Manage")
